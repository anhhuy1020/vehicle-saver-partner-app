                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Column(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          child: Text(widget?.demand?.customer?.name,style: textBoldBlack,),
                                        ),
                                        Text(Utility.parseTimeDate(widget?.demand?.createdDate),style: textStyle,),
                                      ],
                                    ),
                                  ],
                                )
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          ListView.builder(
                              ...
                              reverse: true,
                              itemCount: widget?.demand?.bill?.items?.length,
                              itemBuilder: (BuildContext context, int index) {
                                return Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        widget?.demand?.bill?.items[index].service,
                                        style: textStyle,
                                      ),
                                      Text(
                                          Utility.convertCurrency(widget?.demand?.bill?.items[index].cost),
                                        style: textStyle,
                                      ),
                                    ],
                                  ),
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text(
                                    "Phí",
                                    style: textStyle),
                                Text(Utility.convertCurrency(widget?.demand?.bill?.fee),
                                    style: textStyle),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(Utility.convertCurrency(widget?.demand?.calTotalCost()),
                                    style: TextStyle(
                                        color: blackColor,
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold)),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        Utility.parseTimeInDay(widget?.demand?.completedDate),
                        style: TextStyle(
                            color: Color(0xFF97ADB6), fontSize: 13.0),
                      ),
                    ],
